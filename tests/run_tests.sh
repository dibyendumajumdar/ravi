...
run_ravi_tests language bug2_fixed_arrays.ravi "ravi.jit(false)"
run_ravi_tests language bug3_array_bounds.ravi "ravi.jit(false)"
run_ravi_tests language bug4_integer_array_conversion.ravi "ravi.jit(false)"

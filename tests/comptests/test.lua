...
runfile("inputs/74_luajit_andor.lua")
...
runfile("inputs/lua-Harness-103-nil.t")
--runfile("inputs/lua-Harness-104-number.t")
runfile("inputs/lua-Harness-105-string.t")
runfile("inputs/lua-Harness-106-table.t")
runfile("inputs/lua-Harness-108-userdata.t")
runfile("inputs/lua-Harness-200-examples.t")
runfile("inputs/lua-Harness-201-assign.t")
--runfile("inputs/lua-Harness-202-expr.t")
runfile("inputs/lua-Harness-211-scope.t")
--runfile("inputs/lua-Harness-212-function.t")
runfile("inputs/lua-Harness-213-closure.t")
runfile("inputs/lua-Harness-221-table.t")
runfile("inputs/lua-Harness-222-constructor.t")
runfile("inputs/lua-Harness-223-iterator.t")
runfile("inputs/lua-Harness-231-metatable.t")
runfile("inputs/lua-Harness-232-object.t")

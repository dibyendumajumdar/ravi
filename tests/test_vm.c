...
int main(const char *argv[]) 
{
    ...
    failures += test_luacompexec1("local function x(); local y = 5; if y == 1 then; return 1.0; elseif y == 5 then; return 2.0; else; return 3.0; end; end; local z = x(); print(z); return z", 1);

...
L0 (entry)
	...
	CLOSURE {Proc%2} {T(0)}
	PUTsk {T(0)} {local(matrix, 0), 'T' Ks(0)}
	CLOSURE {Proc%3} {T(0)}
	PUTsk {T(0)} {local(matrix, 0), 'mul' Ks(1)}
	CLOSURE {Proc%4} {T(0)}
	PUTsk {T(0)} {local(matrix, 0), 'gen' Ks(2)}
...
L8
	MOV {Tint(8)} {Tint(7)}
	TGETik {local(a, 0), Tint(7)} {T(0)}
	GETik {T(0), Tint(2)} {T(0)}
	TOFLT {T(0)}
	MOV {T(0)} {Tflt(0)}
	FAPUTfv {Tflt(0)} {local(xi, 2), Tint(7)}
	BR {L6}
L9
	BR {L2}
define Proc%3
L0 (entry)
	...
	MOVi {T(2)} {Tint(2)}
	MOV {T(3)} {local(x, 2)}
	GETsk {Upval(1, Proc%1, matrix), 'T' Ks(1)} {T(0)}
...
L4
	...
	GETsk {T(0), 'numarray' Ks(3)} {T(0)}
	CALL {T(0), Tint(2), 0E0 Kflt(0)} {T(0..), 1 Kint(0)}
	TOFARRAY {T(0[0..])}
	MOV {T(0[0..])} {local(xi, 4)}
	MOV {local(xi, 4)} {T(0)}
	TPUTik {T(0)} {local(x, 2), Tint(3)}
	MOV {1 Kint(0)} {Tint(9)}
	MOV {Tint(2)} {Tint(10)}
...
L8
	MOV {Tint(9)} {Tint(8)}
	TGETik {local(a, 0), Tint(3)} {T(0)}
	TGETik {local(c, 3), Tint(8)} {T(1)}
...
L12
	MOV {Tint(14)} {Tint(13)}
	FAGETik {local(ai, 5), Tint(13)} {Tflt(3)}
	FAGETik {local(cj, 6), Tint(13)} {Tflt(4)}
...
L0 (entry)
	TOINT {local(n, 0)}
	NEWTABLE {T(0)}
	DIVfi {1E0 Kflt(0), local(n, 0)} {Tflt(2)}
	DIVfi {Tflt(2), local(n, 0)} {Tflt(1)}
	MOV {T(0)} {local(a, 1)}
	MOVf {Tflt(1)} {Tflt(0)}
	MOV {1 Kint(0)} {Tint(1)}
...
L4
	...
	LOADGLOBAL {Upval(_ENV), 'table' Ks(0)} {T(0)}
	GETsk {T(0), 'numarray' Ks(1)} {T(0)}
	CALL {T(0), local(n, 0), 0E0 Kflt(1)} {T(0..), 1 Kint(0)}
	TOFARRAY {T(0[0..])}
	MOV {T(0[0..])} {local(ai, 2)}
	MOV {local(ai, 2)} {T(0)}
	TPUTik {T(0)} {local(a, 1), Tint(0)}
	MOV {1 Kint(0)} {Tint(6)}
...
L8
	...
	MULfi {Tflt(0), Tint(10)} {Tflt(2)}
	ADDii {Tint(0), Tint(5)} {Tint(11)}
	SUBii {Tint(11), 2 Kint(1)} {Tint(10)}
	MULfi {Tflt(2), Tint(10)} {Tflt(1)}
	FAPUTfv {Tflt(1)} {local(ai, 2), Tint(5)}
	BR {L6}
L9
	BR {L2}
...
TValue *k = cl->p->k;
StkId base = ci->u.l.base;
lua_Integer raviX__i_0 = 0, raviX__i_1 = 0, raviX__i_2 = 0, raviX__i_3 = 0, raviX__i_4 = 0, raviX__i_5 = 0, raviX__i_6 = 0, raviX__i_7 = 0, raviX__i_8 = 0, raviX__i_9 = 0, raviX__i_10 = 0, raviX__i_11 = 0;
...
raviX__i_3 = 1;
// MOV {Tint(1)} {Tint(4)}
raviX__i_4 = raviX__i_1;
// MOV {1 Kint(0)} {Tint(5)}
raviX__i_5 = 1;
// SUBii {Tint(3), Tint(5)} {Tint(3)}
{ raviX__i_3 = raviX__i_3 - raviX__i_5; }
// BR {L2}
goto L2;
L1:
 return result;
...
L3:
// LIii {Tint(4), Tint(3)} {Tbool(6)}
{ raviX__i_6 = raviX__i_4 < raviX__i_3; }
// CBR {Tbool(6)} {L5, L4}
{ if (raviX__i_6 != 0) goto L5; else goto L4; }
L4:
// MOV {Tint(3)} {Tint(2)}
raviX__i_2 = raviX__i_3;
// LOADGLOBAL {Upval(_ENV), 'table' Ks(0)} {T(0)}
{
...
{
 TValue *tab = R(1);
 TValue *key = &ival0; ival0.value_.i = raviX__i_2;
 TValue *src = R(3);
...
raviX__i_8 = 1;
// MOV {Tint(0)} {Tint(9)}
raviX__i_9 = raviX__i_0;
// MOV {1 Kint(0)} {Tint(10)}
raviX__i_10 = 1;
// SUBii {Tint(8), Tint(10)} {Tint(8)}
{ raviX__i_8 = raviX__i_8 - raviX__i_10; }
// BR {L6}
goto L6;
L5:
// RET {local(x, 1)} {L1}
...
L7:
// LIii {Tint(9), Tint(8)} {Tbool(11)}
{ raviX__i_11 = raviX__i_9 < raviX__i_8; }
// CBR {Tbool(11)} {L9, L8}
{ if (raviX__i_11 != 0) goto L9; else goto L8; }
L8:
// MOV {Tint(8)} {Tint(7)}
raviX__i_7 = raviX__i_8;
// TGETik {local(a, 0), Tint(7)} {T(0)}
{
 TValue *tab = R(0);
 TValue *key = &ival0; ival0.value_.i = raviX__i_7;
 TValue *dst = R(3);
 raviV_gettable_i(L, tab, key, dst);
 base = ci->u.l.base;
}
...
raviX__i_4 = 1;
// MOV {Tint(0)} {Tint(5)}
raviX__i_5 = raviX__i_0;
// MOV {1 Kint(0)} {Tint(6)}
raviX__i_6 = 1;
// SUBii {Tint(4), Tint(6)} {Tint(4)}
{ raviX__i_4 = raviX__i_4 - raviX__i_6; }
// BR {L2}
goto L2;
L1:
 return result;
...
L3:
// LIii {Tint(5), Tint(4)} {Tbool(7)}
{ raviX__i_7 = raviX__i_5 < raviX__i_4; }
// CBR {Tbool(7)} {L5, L4}
{ if (raviX__i_7 != 0) goto L5; else goto L4; }
L4:
// MOV {Tint(4)} {Tint(3)}
raviX__i_3 = raviX__i_4;
// LOADGLOBAL {Upval(_ENV), 'table' Ks(2)} {T(0)}
{
 TValue *tab = cl->upvals[0]->v;
 TValue *key = K(2);
...
{
 TValue *tab = R(2);
 TValue *key = &ival0; ival0.value_.i = raviX__i_3;
 TValue *src = R(7);
 raviV_settable_i(L, tab, key, src);
 base = ci->u.l.base;
}
...
// CBR {Tbool(12)} {L9, L8}
{ if (raviX__i_12 != 0) goto L9; else goto L8; }
L8:
// MOV {Tint(9)} {Tint(8)}
raviX__i_8 = raviX__i_9;
// TGETik {local(a, 0), Tint(3)} {T(0)}
{
 TValue *tab = R(0);
 TValue *key = &ival0; ival0.value_.i = raviX__i_3;
...
{
 TValue *tab = R(3);
 TValue *key = &ival0; ival0.value_.i = raviX__i_8;
 TValue *dst = R(8);
 raviV_gettable_i(L, tab, key, dst);
 base = ci->u.l.base;
}
...
raviX__i_14 = 1;
// MOV {Tint(1)} {Tint(15)}
raviX__i_15 = raviX__i_1;
// MOV {1 Kint(0)} {Tint(16)}
raviX__i_16 = 1;
// SUBii {Tint(14), Tint(16)} {Tint(14)}
{ raviX__i_14 = raviX__i_14 - raviX__i_16; }
// BR {L10}
goto L10;
L9:
// BR {L2}
...
L11:
// LIii {Tint(15), Tint(14)} {Tbool(17)}
{ raviX__i_17 = raviX__i_15 < raviX__i_14; }
// CBR {Tbool(17)} {L13, L12}
{ if (raviX__i_17 != 0) goto L13; else goto L12; }
L12:
// MOV {Tint(14)} {Tint(13)}
...
// FAPUTfv {Tflt(0)} {local(xi, 4), Tint(8)}
{
 ...
 lua_Unsigned ukey = (lua_Unsigned) raviX__i_8;
 lua_Number *iptr = (lua_Number *)arr->data;
 if (ukey < (lua_Unsigned)(arr->len)) {
 iptr[ukey] = raviX__f_0;
} else {
...
// DIVfi {1E0 Kflt(0), local(n, 0)} {Tflt(2)}
{ raviX__f_2 = 1E0 / ((lua_Number)(ivalue(R(0)))); }
// DIVfi {Tflt(2), local(n, 0)} {Tflt(1)}
{ raviX__f_1 = raviX__f_2 / ((lua_Number)(ivalue(R(0)))); }
// MOV {T(0)} {local(a, 1)}
{
 const TValue *src_reg = R(3);
 TValue *dst_reg = R(1);
...
// SUBii {Tint(0), Tint(5)} {Tint(10)}
{ raviX__i_10 = raviX__i_0 - raviX__i_5; }
// MULfi {Tflt(0), Tint(10)} {Tflt(2)}
{ raviX__f_2 = raviX__f_0 * ((lua_Number)(raviX__i_10)); }
// ADDii {Tint(0), Tint(5)} {Tint(11)}
{ raviX__i_11 = raviX__i_0 + raviX__i_5; }
// SUBii {Tint(11), 2 Kint(1)} {Tint(10)}
{ raviX__i_10 = raviX__i_11 - 2; }
// MULfi {Tflt(2), Tint(10)} {Tflt(1)}
{ raviX__f_1 = raviX__f_2 * ((lua_Number)(raviX__i_10)); }
// FAPUTfv {Tflt(1)} {local(ai, 2), Tint(5)}
{
 RaviArray *arr = arrvalue(R(2));

...
#define LUACOCO_VERSION		"Coco 1.1.7"
#define LUACOCO_VERSION_NUM	10107
...
#define LUA_EXTRASPACE		sizeof(coco_State)
...
#define luai_userstatefree(L,L1)	if (LHASCOCO(L)) luaCOCO_free(L)
